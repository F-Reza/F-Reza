...
✔ 4+ Years in Mobile & Web App Development
✔ Expertise: Flutter, Laravel, Firebase, REST APIs, MySQL, JavaFX, PowerBI
...
<b><i style="font-size: 11px;">Note:</i></b> <span style="font-size: 9px;"><i>Top languages is only a metric of the languages my public code consists of, and doesn't reflect experience or skill level.</i></span>
